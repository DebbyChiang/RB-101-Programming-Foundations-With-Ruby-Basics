...
# he ran it, he got an error. Something about the limit variable. 
# What's wrong with the code?
#The limit variable is outside the scope of the method.
#Place the limit as an argument
...
#place the limit as an argument within the function